# Mic Notes — Ruth the Musical

Allen & Heath GLD 112 · 11 packs · 16 headsets

---

## Pre-Show: Headset Fitting

We have 18 actors and 16 headsets — fit headsets on everyone **except**:
...
### ⚡ ACT I → ACT II BLACKOUT (quick — be ready in wings)

Trigger: Lights go black after "God Provides" (Elimalek's death song)

**4 pack swaps — headsets stay on actors:**

| Channel | From | To |
|---|---|---|
| CH04 RUTH | Alan Miller | Elsie Weldon |
| CH06 RAHAB | Zoe Yoder | Jamian Esh |
...
### ⚡ ACT II — DEATH SCENE → FLASHBACK BLACKOUT (quick)
...
### ☕ INTERMISSION — Act II → Act III (more time)
...
| Headset | From | To |
|---|---|---|
| CH05 headset | Canon Beiler *(returns it)* | Chrit Glick *(gets headset back)* |

**Board actions:**
- Unmute CH05 BOAZ (Chrit has headset back, now active as Boaz)
- Unmute CH09 ELIZ (Olivia back as Elizabeth)
- Unmute CH10 ABIGAIL (Hannah F. back as Abigail)
- CH04 RUTH stays hot — Elsie continues
...
CH05, CH09, CH10 — muted (idle)

After death scene blackout, CH06 and CH08 move to the child actors for the flashback.
...
| Actor | Characters | Channel |
|---|---|---|
| Bethany Miller | Narrator | CH01 NARR — full show |
| Naomi Miller | Naomi | CH02 NAOMI — full show |
